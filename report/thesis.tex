...
increased between 2013 and 2022 and is expected to keep increasing \citet{statista}, the need for
...
in the Netherlands, then solve these for the actual shortest paths using the Lin–Kernighan \citet{lin1973effective} heuristic.
...
but the formula still performs well (\citet{figliozzi2008planning}).
...
\begin{table}[htbp]
	\centering
	\caption{Estimates of the circuity factor $c$ and its corresponding $\beta_c$ (\citet{merchan2019empirical})}
...
solution algorithm is needed. The Lin-Kernighan \citet{lin1973effective} heuristic provides outcome,
it is generally considered to be one of the most effective methods of generating (near) optimal
solutions for the TSP.
In this research a modified implementation of the heuristic is used \citet{helsgaun2000effective}.
