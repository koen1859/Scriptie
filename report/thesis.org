...
* Literature Review
In this section we review the existing literature on the Beardwood formula and some applications,
and on the Lin-Kernighan heuristic and its implementations.
** Applications of the Beardwood formula
We are interested in the performance of formula \ref{eq:beardwood} for
...
but the formula still performs well.
