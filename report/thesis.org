...
between $1.12$ and $5.60$ [cite:merchan2019empirical]. Then, equation \ref{eq:beardwood} becomes:
#+NAME: eq:beardwood_circuity
#+BEGIN_EXPORT latex
\begin{align}
	L\to c\beta\sqrt{nA},\text{ as }n\to\infty
	\label{eq:beardwood_circuity}
\end{align}
#+END_EXPORT
* Methodology
* References
